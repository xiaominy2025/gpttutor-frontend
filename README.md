# Engent Labs: Active Learning Platform V1.6.5
...
- **Story in Action**: Real-world scenario illustrations
...
Each course requires metadata in `src/config/courseData.js`:
...
export const COURSES = {
  your_course: {
    ...
    shortName: "Your Lab",
    mobile_title: "Your Lab",  // V1.6.5 mobile title
...
```bash
# Create new version
git tag -a v1.6.5 -m "Version 1.6.5: Enhanced UI and History Features"
